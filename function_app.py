...
@app.service_bus_queue_trigger(arg_name="azservicebus", queue_name="logqueue",
                               connection="LogPassing_SERVICEBUS") 
def queue_trigger(azservicebus: func.ServiceBusMessage):
...
#                                queue_name="logqueue",
#                                connection="LogPassing_SERVICEBUS")
# def queue_trigger(receivedmessage: servicebus.ServiceBusReceivedMessage):
